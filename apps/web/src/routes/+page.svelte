...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
  ...
  <div class="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
    ...
    <a href={resolve('/structuring')} class="card bg-base-200 border border-base-300 transition-all duration-200 hover:border-primary/50 hover:bg-base-200/80 p-8 group">
      <div class="flex items-center space-x-4 mb-4">
        ...
        <h2 class="text-2xl font-semibold text-base-content group-hover:text-accent transition-colors">
  ...
  <div class="mt-16">
    ...
    <div class="grid sm:grid-cols-2 lg:grid-cols-5 gap-4 max-w-5xl mx-auto">
      ...
      <div class="text-center p-4">
        <div class="w-10 h-10 bg-accent/20 rounded-full flex items-center justify-center mx-auto mb-2">
          <span>📈</span>
        </div>
