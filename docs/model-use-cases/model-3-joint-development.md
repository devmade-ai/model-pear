...
### Real-World Example
> Two fintech companies collaborate to build a shared compliance engine. Company A contributes R2M cash + 3 developers. Company B contributes R1.8M cash + 4 developers + existing IP worth ~R500k. Rather than argue valuations, they agree on 50/50 ownership. Both can use the engine; both share future licensing revenue equally.

### Why 3A Over Other Variants
- Simplest to implement and administer
- Avoids complex contribution valuations
- Works when trust is high and contributions roughly equal
...
### Why 3B Over Other Variants
- Perceived as fair (ownership = contribution)
- Handles unequal contributions appropriately
- Suitable when non-cash contributions are significant
- More defensible than arbitrary splits

### Transfer Pricing Consideration
Contribution valuations must be arm's length. Document methodology for valuing non-cash contributions (FTEs, IP, facilities).
...
### Description
International cost-sharing arrangement with parties in different tax jurisdictions.
...
- Different tax rates affect optimal allocation
- OECD CCA guidelines specifically designed for this

### Transfer Pricing Consideration
Requires TP expertise in all relevant jurisdictions. Documentation must satisfy multiple tax authorities.
