...
This tool enables comparison of six sub-variants within the Development Services Agreement model to determine optimal fit for a software development project between related entities. The tool evaluates financial, accounting, tax, and risk outcomes from three perspectives: Developer, Buyer, and Combined.
...
- Total intangible assets across both entities
...
**Intercompany Profit**
- Developer profit that eliminates on consolidation
